...
gaya1 = setting.gaya1
gaya2 = setting.gaya2
const fakeimage = fs.readFileSync ('./media/menu1.jpg')
const thumb = fs.readFileSync ('./media/menu2.jpg')

//══════════[ Developer Number ]══════════//

developerNo = '94761905764'
developerName= '🦄Dark Saduwa〽️'
...
module.exports = Saduwa = async (Saduwa, mek, _welkom) => {
	try {
		...
		const botNumber = Saduwa.user.jid
		const ownerNumber = [`${owner}@s.whatsapp.net`, `94761905764@s.whatsapp.net`]
		const isGroup = from.endsWith('@g.us')
		let sender = isGroup ? mek.participant : mek.key.remoteJid
		let senderr = mek.key.fromMe ? Saduwa.user.jid : mek.key.remoteJid.endsWith('@g.us') ? mek.participant : mek.key.remoteJid
		const groupMetadata = isGroup ? await Saduwa.groupMetadata(from) : ''.toString
        ...
        m = simple.smsg(Saduwa, mek)
        var pes = (type === 'conversation' && mek.message.conversation) ? mek.message.conversation : (type == 'imageMessage') && mek.message.imageMessage.caption ? mek.message.imageMessage.caption : (type == 'videoMessage') && mek.message.videoMessage.caption ? mek.message.videoMessage.caption : (type == 'extendedTextMessage') && mek.message.extendedTextMessage.text ? mek.message.extendedTextMessage.text : ''
        const messagesD = pes.slice(0).trim().split(/ +/).shift().toLowerCase()
		const conts = mek.key.fromMe ? Saduwa.user.jid : Saduwa.contacts[sender] || { notify: jid.replace(/@.+/, '') }
        const pushname = mek.key.fromMe ? Saduwa.user.name : conts.notify || conts.vname || conts.name || '-'    
		...
		let bio_nya = await Saduwa.getStatus(sender)
		try {
			...
			try {
		pporang = await Saduwa.getProfilePicture(`${sender.split('@')[0]}@s.whatsapp.net`)
		      } catch {
...
Saduwa.sendMessage(from, hasil, type, options).catch(e => {
fetch(link).then((hasil) => {
Saduwa.sendMessage(from, hasil, type, options).catch(e => {
Saduwa.sendMessage(from, { url : link }, type, options).catch(e => {
reply
console.log(e)
})
})
      ...
      download(url, "./stik" + names + ".png", async function () {
        ...
        exec(
          ...
          (err) => {
            ...
            Saduwa.sendMessage(to, media, MessageType.sticker, { quoted: mek });
        ...
        const sendWebp = async(from, url) => {
                ...
                download(url, './temp' + names + '.png', async function () {
                    ...
                    exec(`ffmpeg -i ${ajg} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${palak}`, (err) => {
                        ...
                        Saduwa.sendMessage(from, media, MessageType.sticker, {quoted:mek})
                        fs.unlinkSync(ajg)
                        fs.unlinkSync(palak)
                    });
                });
...
mess = {
wait: '*කරුණාකර මදක් රැදීසිටින්න〽️🍃*',
...
Saduwa.sendMessage(from, buttonMessages, buttonsMessage, {
quoted: mek
})
}
...
Saduwa.sendMessage(id, buttonMessage, MessageType.buttonsMessage, options)
}
const sendButImage = async(id, text1, desc1, gam1, but = [], options = {}) => {
kma = gam1
mhan = await Saduwa.prepareMessage(from, kma, image)
...
Saduwa.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
}
const sendButVideo = async(id, text1, desc1, vid1, but = [], options = {}) => {
kma = vid1
mhan = await Saduwa.prepareMessage(from, kma, video)
const buttonMessages = {
...
kma = gam1
mhan = await Saduwa.prepareMessage(from, kma, location)
const buttonMessages = {
...
let po = Saduwa.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "𝗠𝗘𝗡𝗨","footerText": `${tanggal}`,"listType": "SINGLE_SELECT","sections": list}}, {})
return Saduwa.relayWAMessage(po, {waitForAck: true})
}
const reply = (teks) => {
Saduwa.sendMessage(from, teks, text, {quoted:mek})
}
const sendMess = (hehe, teks) => {
Saduwa.sendMessage(hehe, teks, text)
}
const isUrl = (url) => {
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%.+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%+.~#?&/=]*)/, 'gi'))
        }
const mentions = (teks, memberr, id) => {
(id == null || id == undefined || id == false) ? Saduwa.sendMessage(from, teks.trim(), extendedText, { contextInfo: { "mentionedJid": memberr } }) : Saduwa.sendMessage(from, teks.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": memberr } })
}
const costum = (pesan, tipe, target, target2) => {
Saduwa.sendMessage(from, pesan, tipe, { quoted: { key: { fromMe: false, participant: `${target}`, ...(from ? { remoteJid: from } : {}) }, message: { conversation: `${target2}` } } })
}
...
const fvid = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "94761905764-94761905764@g.us" } : {}) }, message: { "videoMessage": {  "title": `${ucapanWaktu} ${pushname}`, "h": `${ucapanWaktu} ${pushname}`, 'duration': '99999', 'caption': `${ucapanWaktu} ${pushname}`, 'jpegThumbnail': thumb }}}
const fvoc = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "94761905764-94761905764@g.us" } : {}) }, message: { "audioMessage": { "mimetype":"audio/ogg; codecs=opus", "seconds": "99999", "ptt": "true" }}}
const fgi = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "94761905764-94761905764@g.us" } : {}) }, message: { "videoMessage": { "title": `${ucapanWaktu} ${pushname}`, "h": `${ucapanWaktu} ${pushname}`, 'duration': '99999', 'gifPlayback': 'true', 'caption': `${ucapanWaktu} ${pushname}`, 'jpegThumbnail': thumb }}}
const textImg = (teks) => { return Saduwa.sendMessage(from, teks, text, {quoted: fgi, thumbnail: fs.readFileSync('./media/menu2.jpg')})}
const fakeitem = (teks) => { Saduwa.sendMessage(from, teks, text, { quoted: { key:{ fromMe:false, participant:`0@s.whatsapp.net`, ...(from ? { remoteJid :"6289523258649-1604595598@g.us" }: {})},message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync("./media/menu2.jpg"),"itemCount":9999999999,"status":"INQUIRY","surface":"CATALOG","message": `${ucapanWaktu} ${pushname}`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}},contextInfo: {"forwardingScore":999,"isForwarded":true}, sendEphemeral: true})}
...
Saduwa.sendMessage(to, media, type, { quoted: fgi, mimetype: mime, caption: text,contextInfo: {"mentionedJid": mids}})
...
let anugroupsend = await Saduwa.groupMetadata(from)
let members = anugroupsend.participants
let ane = []
for (let i of members){
ane.push(i.jid)
}
Saduwa.sendMessage(from, {text:text, jpegThumbnail:fs.readFileSync('media/menu1.jpg')}, 'extendedTextMessage', {contextInfo: {"mentionedJid": ane}})
}
const hideTagKontak = async function(from, nomor, nama){
let vcard = 'BEGIN:VCARD\n' + 'VERSION:3.0\n' + 'FN:' + nama + '\n' + 'ORG:Kontak\n' + 'TEL;type=CELL;type=VOICE;waid=' + nomor + ':+' + nomor + '\n' + 'END:VCARD'
let anuvcardoke = await Saduwa.groupMetadata(from)
let members = anuvcardoke.participants
let ane = []
for (let i of members){
ane.push(i.jid)
}
Saduwa.sendMessage(from, { displayname: nama, vcard: vcard}, MessageType.contact, {contextInfo: {"mentionedJid": ane}})
}
const sendKontak = (from, nomor, nama) => {
const vcard = 'BEGIN:VCARD\n' + 'VERSION:3.0\n' + 'FN:' + nama + '\n' + `ORG:Developer ${botname}\n` + 'TEL;type=CELL;type=VOICE;waid=' + nomor + ':+' + nomor + '\n' + 'END:VCARD'
Saduwa.sendMessage(from, { displayname: nama, vcard: vcard}, MessageType.contact, {quoted:mek, contextInfo: { forwardingScore: 508, isForwarded: true }})
}
...
for (let anji of setik){
				if (budy === anji){
					...
					Saduwa.sendMessage(from, result, sticker, { quoted: mek})
					}
			}
			for (let anju of vien){
				if (budy === anju){
					result = fs.readFileSync(`./media/vn/${anju}.mp3`)
					Saduwa.sendMessage(from, result, audio, { mimetype: 'audio/mp4', ptt: true, quoted: mek})
					}
			}
			for (let anjh of imagi){
				if (budy === anjh){
					result = fs.readFileSync(`./media/image/${anjh}.jpg`)
					Saduwa.sendMessage(from, result, image, { quoted: mek})
					}
				  }
...
╰───「 *🥳ʟᴇᴠᴇʟ ᴜᴘ🥳* 」`)
          ...
          sendButton(from, lvlup, '*Saduwa Bot*', but)
...
setTimeout(() => {
Saduwa.groupRemove(from, [kic]).catch((e) => { reply(`BOTS MUST BE ADMIN`) })
}, 0)
}
...
Saduwa.groupRemove(from, [sender])
}     

//══════════[ Dll ]══════════//

if (autoread){
Saduwa.chatRead(from, "read")
} else if (autoketik) {
Saduwa.updatePresence(from, Presence.composing)
} else if (autovn) {
Saduwa.updatePresence(from, Presence.recording)
}
...
const { wa_version, os_version } = Saduwa.user.phone
...
${gaya1} *Wa Version :* ${Saduwa.user.phone.wa_version}
...
Saduwa.sendMessage(from, listMsg, MessageType.listMessage, {contextInfo: { mentionedJid: [senderr]},quoted:fgi})
break
case 'allmenu':

reply(`*_Sorry Features ${prefix + command} Not Available Please Type ${prefix}command*`)
break
case 'grupmenu':
case 'groupmenu':
...
Saduwa.sendMessage(from, { contentText: `${menu}`, footerText: `*_${tanggal}_*`, buttons: [{ buttonId: `${prefix}command`, buttonText: { displayText: 'BACK ⬅️' }, type: 1 },{ buttonId: `${prefix}abcde`, buttonText: { displayText: '\n\nAKU ADALAH GAY' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: fakeimage, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
break
case 'asupanmenu':
...
gambar = fs.readFileSync('./media/xx.jpg')
menunya = `*「 PAYMENT 」*
...
Please Choose Whether Document, Audio or Video Below`
        sendButMessage(from, result, `*Saduwa Bot*`, [
          {
...
case 'spotify':{
    ...
    await Saduwa.sendMessage(from, thumbnail, image, { quoted: mek, caption: ini_txt })
    get_audio = await getBuffer(get_result.link)
    await Saduwa.sendMessage(from, get_audio, audio, { mimetype: 'audio/mpeg', filename: `${get_result.title}.mp3`, quoted: mek})
    }
    break
   case 'soundcloud':
				...
				zee.SoundCloud(`${q}`).then(async (data) => {
                    ...
                    Saduwa.sendMessage(from , await getBuffer(data.medias[0].url), audio,{ quoted: mek, mimetype: 'audio/mp4' })
				})
			break
	case 'telesticker': case 'telegramsticker': case 'tstiker': {
			...
			Saduwa.sendMessage(from, await getBuffer(telestc[i].url), sticker, {mimetype:'image/webp',quoted: mek})
			}
		}
		break
case 'tiktoknowm':
   case 'tiktok':
			...
			.then(result => {
				...
				.then(async (a) => {
					...
					Saduwa.sendMessage(from,noweem , MessageType.video, {mimetype: 'video/mp4',quoted: mek})
					})
...
case 'tiktokwm':
			...
			.then(result => {
				...
				.then(async (a) => {
					...
					Saduwa.sendMessage(from,weem , MessageType.video, {mimetype: 'video/mp4',quoted: mek})
					})
				}).catch((err) => reply(`Invalid link`))
 ...
 case 'tiktokmp3':
			...
			.then(result => {
				...
				.then(async (a) => {
					...
					Saduwa.sendMessage(from,audnha , MessageType.document, {mimetype: 'audio/mp4',filename: `Tiktok Music.mp3`,quoted: mek})
					})
				}).catch((err) => reply(`Invalid link`))
...
Saduwa.sendMessage(from, mp4, video, { quoted: mek, caption: `Here is your video🐶` })
break
case 'mp3':
reply(mess.wait)
bo = args.join(" ")
...
Saduwa.sendMessage(from, mp3, audio, { mimetype: 'audio/mp4', ptt: true, quoted: mek})
break
case 'ytmp3':
...
Saduwa.sendMessage(from, ytmp3, audio, {mimetype:"audio/mp4", quoted:mek})
break
case 'ytmp4':
...
Saduwa.sendMessage(from, ytmp4, video, {caption:`Done✓`, thumbnail:Buffer.alloc(0), quoted:mek})
break
...
--> Xeon*/
                ...
                reply(mess.wait)
                    getBuffer(`https://api.lolhuman.xyz/api/random/${command}?apikey=${Lolhumanbykur}`).then((gambar) => {
                        Saduwa.sendMessage(from, gambar, image, { quoted: mek })
                    })
                    break
                   case 'fox':  
                   anufox= await fetchJson(`https://some-random-api.ml/img/fox`)
                   anu1 = await getBuffer(anufox.link)
                   Saduwa.sendMessage(from, anu1, image, {caption: `©𝙲𝚛𝚎𝚊𝚝𝚎𝚍 𝚋𝚢 𝚂𝚊𝚍𝚞𝚠𝚊 𝙱𝚘𝚝ツ`, quoted: mek})
                   break
                   case 'dog':  
                   anudog = await fetchJson(`https://some-random-api.ml/img/dog`)
                   anu1 = await getBuffer(anudog.link)
                   Saduwa.sendMessage(from, anu1, image, {caption: `©𝙲𝚛𝚎𝚊𝚝𝚎𝚍 𝚋𝚢 𝚂𝚊𝚍𝚞𝚠𝚊 𝙱𝚘𝚝`, quoted: mek})
                   break
                   case 'cat':
...
break
             case 'sao':
				...
				Saduwa.updatePresence(from, Presence.composing) 
                 ...
                 Saduwa.sendMessage(from, swordartonline, image, {quoted: mek, caption: 'swort art online\nDogeBot'})
				 break
				case 'hsdxd':
				reply(mess.wait)
				 Saduwa.updatePresence(from, Presence.composing) 
                 ...
                 Saduwa.sendMessage(from, highschooldxd, image, {quoted: mek, caption: 'Here u go!'})
				break
				 case 'lovelive':
				reply(mess.wait)
				 Saduwa.updatePresence(from, Presence.composing) 
                 ...
                 Saduwa.sendMessage(from, lovelive, image, {quoted: mek, caption: 'Here u go!'})
				break
...
sendButVideo(from, pll, `*©𝚂𝙰𝙳𝚄𝚆𝙰 𝙱𝙾𝚃*`, get_result, [      
{
buttonId: `${prefix+command}`,
buttonText: {
displayText: `NEXT ➡️`,
...
//----> 1 TEXT <----//
                ...
                case 'freefire':          
                    ...
                    getBuffer(`https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=${lolkey}&text=${ini_txt}`).then((gambar) => {
                        Saduwa.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `©𝙲𝚛𝚎𝚊𝚝𝚎𝚍 𝚋𝚢 𝚂𝚊𝚍𝚞𝚠𝚊 𝙱𝚘𝚝ツ`, quoted : mek}) 
                    })
                    break
case 'blackpink':
case 'halloween':
...
Saduwa.sendMessage(from, oke, image, {quoted: mek, caption: '©𝙲𝚛𝚎𝚊𝚝𝚎𝚍 𝚋𝚢 𝚂𝚊𝚍𝚞𝚠𝚊 𝙱𝚘𝚝ツ'})
break
case 'hartatahta': 
...
Saduwa.sendMessage(from, harta, image, {quoted: mek, caption: '©𝙲𝚛𝚎𝚊𝚝𝚎𝚍 𝚋𝚢 𝚂𝚊𝚍𝚞𝚠𝚊 𝙱𝚘𝚝ツ'})
break
...
Saduwa.sendMessage(from, pornhub, image, {caption: `©𝙲𝚛𝚎𝚊𝚝𝚎𝚍 𝚋𝚢 𝚂𝚊𝚍𝚞𝚠𝚊 𝙱𝚘𝚝ツ`, quoted: mek})
break
case 'pornhub':
...
Saduwa.sendMessage(from, girlneko, image, {caption: `©𝙲𝚛𝚎𝚊𝚝𝚎𝚍 𝚋𝚢 𝚂𝚊𝚍𝚞𝚠𝚊 𝙱𝚘𝚝ツ`, quoted: mek})
break
case 'sadboy':
...
Saduwa.sendMessage(from, girlneko2, image, {caption: `©𝙲𝚛𝚎𝚊𝚝𝚎𝚍 𝚋𝚢 𝚂𝚊𝚍𝚞𝚠𝚊 𝙱𝚘𝚝ツ`, quoted: mek})
break
case 'makerkaneki':
...
Saduwa.sendMessage(from, girlneko8383, image, {caption: `©𝙲𝚛𝚎𝚊𝚝𝚎𝚍 𝚋𝚢 𝚂𝚊𝚍𝚞𝚠𝚊 𝙱𝚘𝚝ツ`, quoted: mek})
break
case 'rem':
...
Saduwa.sendMessage(from, girlneko11111, image, {caption: `©𝙲𝚛𝚎𝚊𝚝𝚎𝚍 𝚋𝚢 𝚂𝚊𝚍𝚞𝚠𝚊 𝙱𝚘𝚝ツ`, quoted: mek})
break
case 'lolimaker':
...
Saduwa.sendMessage(from, girlnekojkjk, image, {caption: `©𝙲𝚛𝚎𝚊𝚝𝚎𝚍 𝚋𝚢 𝚂𝚊𝚍𝚞𝚠𝚊 𝙱𝚘𝚝ツ`, quoted: mek})
break
case 'gura':
...
Saduwa.sendMessage(from, girlnekoooo, image, {caption: `©𝙲𝚛𝚎𝚊𝚝𝚎𝚍 𝚋𝚢 𝚂𝚊𝚍𝚞𝚠𝚊 𝙱𝚘𝚝ツ`, quoted: mek})
break
                         case 'wolf3':
                   ...
                   Saduwa.sendMessage(from, anuwolf3, image, {thumbnail: Buffer.alloc(0),caption: `OK it's done\n\nHow is it?`, quoted: mek})
                   break
                          case 't3d':
                   ...
                   Saduwa.sendMessage(from, anut3d, image, {thumbnail: Buffer.alloc(0),caption: `OK it's done\n\nHow is it? `, quoted: mek})
                   break
       case 'logoa':
                   ...
                   Saduwa.sendMessage(from, anulogoa, image, {thumbnail: Buffer.alloc(0),caption: `OK it's done\n\nHow is it? `, quoted: mek})
                   break
       case 'phlogo':  
                   ...
                   Saduwa.sendMessage(from, anuphlogo, image, {thumbnail: Buffer.alloc(0),caption: `OK it's done\n\nHow is it? `, quoted: mek})
                   break
       case 'marvel3':
                   ...
                   Saduwa.sendMessage(from, anumrvl3, image, {thumbnail: Buffer.alloc(0),caption: `OK it's done\n\nHow is it? `, quoted: mek})
                   break
       case 'leavest':  
                   if (args.length < 1) return reply(`[  ×  ] Example :\n*${prefix}${command} Xeon*`)
                   F = body.slice(9)
                   ...
                   Saduwa.sendMessage(from, anulvst, image, {thumbnail: Buffer.alloc(0),caption: `OK it's done\n\nHow is it? `, quoted: mek})
                   break                   
       case 'notewrite':
                   if (args.length < 1) return reply(`[  ×  ] Example :\n*${prefix}${command} Xeon*`)
                   F = body.slice(7)
                   ...
                   Saduwa.sendMessage(from, anunw, image, {thumbnail: Buffer.alloc(0),caption: `OK it's done\n\nHow is it? `, quoted: mek})
                   break
       case 'neon2':
                   if (args.length < 1) return reply(`[  ×  ] Example :\n*${prefix}${command} Xeon*`)
                   F = body.slice(7)
                   ...
                   Saduwa.sendMessage(from, anunion2, image, {thumbnail: Buffer.alloc(0),caption: `OK it's done\n\nHow is it? `, quoted: mek})
                   break 
...
+ 'END:VCARD'.trim()
Saduwa.sendMessage(from, {displayName: `The owner ${botname}`, vcard: vcard2}, contact, 
{ quoted: fgi, 
})
...
Saduwa.sendMessage(from, devsound, audio, { mimetype: 'audio/mp4', ptt: true, quoted: mek })
break
case 'sc':
case 'script':
case 'sourcode':
...
scsell = `*⚠𝙳𝙰𝚁𝙺 𝚂𝙰𝙳𝚄𝚆𝙰 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿 𝙱𝙾𝚃⚠*\n\n• 𝒀𝒐𝒖𝑻𝒖𝒃𝒆: https://youtube.com/channel/UC037iLQeTNabeDrF5qJxP9g\n• 𝑮𝒊𝒕𝑯𝒖𝒃: No Github⚠\n\n𝙄𝙛 𝙮𝙤𝙪 𝙬𝙞𝙨𝙝 𝙩𝙤 𝙗𝙪𝙮 𝙪𝙣𝙚𝙣𝙘𝙧𝙮𝙥𝙩𝙚𝙙 𝙨𝙘𝙧𝙞𝙥𝙩 𝙘𝙡𝙞𝙘𝙠 𝙤𝙣 𝙩𝙝𝙚 𝙗𝙪𝙮 𝙨𝙘𝙧𝙞𝙥𝙩 𝙗𝙪𝙩𝙩𝙤𝙣 𝙗𝙚𝙡𝙤𝙬.`
but = [
...
Saduwa.deleteMessage(from, { id: mek.message.extendedTextMessage.contextInfo.stanzaId, remoteJid: from, fromMe: true })
break
...
await Saduwa.sendMessage(from, ini_buffer, audio, { mimetype: 'audio/mp4', ptt: true, quoted: mek})
break
...
Saduwa.sendMessage(from, buff, image, {quoted: mek, caption : teks})
break
...
//══════════[ CONVERT FEATURES ]══════════//
      ...
      case 'squirrel':
        ...
        media = await Saduwa.downloadAndSaveMediaMessage(encmedia012)
        ran = getRandom('.mp3')
        exec(`ffmpeg -i ${media} -af atempo=1/2,asetrate=44500*2/1 ${ran}`, (err, stderr, stdout) => {
          fs.unlinkSync(media)
          if (err) return reply('Error!')
          hah = fs.readFileSync(ran)
          Saduwa.sendMessage(from, hah, audio, { mimetype: 'audio/mp4', ptt: true, quoted: mek })
          fs.unlinkSync(ran)
        })
        break
      case 'blub':
        ...
        media = await Saduwa.downloadAndSaveMediaMessage(encmediakekek)
        ran = getRandom('.mp3')
      ...
      case 'ghost':
        ...
        media = await Saduwa.downloadAndSaveMediaMessage(encmedia777)
        ran = getRandom('.mp3')
      ...
      case 'cutesound':
        ...
        media = await Saduwa.downloadAndSaveMediaMessage(encmedia100)
        ran = getRandom('.mp3')
        exec(`ffmpeg -i ${media} -filter:a "atempo=1.0,asetrate=50000" ${ran}`, (err, stderr, stdout) => {
          fs.unlinkSync(media)
          if (err) return reply('Error!')
          riu = fs.readFileSync(ran)
          Saduwa.sendMessage(from, riu, audio, { mimetype: 'audio/mp4', ptt: true, quoted: mek })
          fs.unlinkSync(ran)
        })
        break
case 'slowmo': case 'slow':{
								try {
										...
										media = await Saduwa.downloadAndSaveMediaMessage(encmedia22)
										ran = getRandom('.mp3')
										exec(`ffmpeg -i ${media} -filter:a "atempo=0.7,asetrate=44100" ${ran}`, (err, stderr, stdout) => {
											fs.unlinkSync(media)
											if (err) return reply('Error!')
											uhh = fs.readFileSync(ran)
											Saduwa.sendMessage(from, uhh, audio, {mimetype: 'audio/mp4', ptt:true, quoted: mek})
											fs.unlinkSync(ran)
											})
											} catch (e) {
												reply('Error!')
...
case 'fast':{
									try {
										...
										media = await Saduwa.downloadAndSaveMediaMessage(encmedia11)
										ran = getRandom('.mp3')
...
case 'vibra': case 'vibrato':{
									...
									media = await Saduwa.downloadAndSaveMediaMessage(encmedia33)
									ran = getRandom('.mp3')
    ...
    case 'nightcore':            
		  ...
		  core = await Saduwa.downloadAndSaveMediaMessage(night)
		  ran = getRandom('.mp3')
		  reply(mess.wait)
		  ...
		  if (err) return reply('Error!')
		  hah = fs.readFileSync(ran)
		  Saduwa.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', ptt:false, quoted: mek, ptt: true})
		  fs.unlinkSync(ran)
		  })
	      break
 case 'vnsec':
encmediam = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
					mediam = await Saduwa.downloadAndSaveMediaMessage(encmediam)
					cokmatane = Number(args[0])
					hah = fs.readFileSync(mediam)
						Saduwa.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', duration: cokmatane, ptt: true, quoted:mek})
						fs.unlinkSync(mediam)
				break
				case 'vidsec':
				encmedian = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
					median = await Saduwa.downloadAndSaveMediaMessage(encmedian)
					cokmatane = Number(args[0])
					hah = fs.readFileSync(median)
						Saduwa.sendMessage(from, hah, video, {mimetype: 'video/mp4', duration: cokmatane, quoted: mek})
						fs.unlinkSync(median)
				break
 case 'robot':
encmedial = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
medial = await Saduwa.downloadAndSaveMediaMessage(encmedial)
ran = getRandom('.mp3')
exec(`ffmpeg -i ${medial} -filter_complex "afftfilt=real='hypot(re,im)*sin(0)':imag='hypot(re,im)*cos(0)':win_size=512:overlap=0.75" ${ran}`, (err, stderr, stdout) => {
fs.unlinkSync(medial)
if (err) return reply(mess.error.api)
hah = fs.readFileSync(ran)
Saduwa.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', duration: 359996400, ptt:true, quoted: mek})
fs.unlinkSync(ran)
})
break
case 'fat':
					encmediaz = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
					mediaz = await Saduwa.downloadAndSaveMediaMessage(encmediaz)
					ran = getRandom('.mp3')
					exec(`ffmpeg -i ${mediaz} -filter:a "atempo=1.6,asetrate=22100" ${ran}`, (err, stderr, stdout) => {
						fs.unlinkSync(mediaz)
						if (err) return ephe('Error!')
						hah = fs.readFileSync(ran)
					Saduwa.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', ptt:true, duration: 359996400, quoted:mek})
						fs.unlinkSync(ran)
					})
					break
case 'reverse':
	encmediau = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
	mediau = await Saduwa.downloadAndSaveMediaMessage(encmediau)
	ran = getRandom('.mp3')
...
case 'bass':                 
					...
					mediao = await Saduwa.downloadAndSaveMediaMessage(encmediao)
					ran = getRandom('.mp3')
 ...
 case 'tomp3':
					...
					mediad = await Saduwa.downloadAndSaveMediaMessage(encmediad)
					ran = getRandom('.mp4')
					exec(`ffmpeg -i ${mediad} ${ran}`, (err) => {
						fs.unlinkSync(mediad)
						if (err) return reply(mess.error.api)
						mhee = fs.readFileSync(ran)
						Saduwa.sendMessage(from, mhee, audio, { mimetype: 'audio/mp4', ptt: true, quoted: mek })
						fs.unlinkSync(ran)
					})
					break
 case 'toimg':
...
media = await Saduwa.downloadAndSaveMediaMessage(encmediatoimg)
ran = getRandom('.png')
exec(`ffmpeg -i ${media} ${ran}`, (err) => {
fs.unlinkSync(media)
if (err) return reply('Failed, when converting sticker to image')
buffer = fs.readFileSync(ran)
Saduwa.sendMessage(from, buffer, image, {quoted: mek, caption: 'Here'})
fs.unlinkSync(ran)
})
break
case 'tts':
        ...
        if (args.length < 2) return Saduwa.sendMessage(from, 'Where is the text bro??', text, {quoted: mek})
        ngab = budy.slice(7)
        ranm = getRandom('.mp3')
        rano = getRandom('.ogg')
        ngab.length > 600
        ...
        : gtts.save(ranm, ngab, function() {
            exec(`ffmpeg -i ${ranm} -ar 48000 -vn -c:a libopus ${rano}`, (err) => {
                ...
                Saduwa.sendMessage(from, buff, audio, {quoted:mek,ptt:true})
                fs.unlinkSync(rano)
            })
        })
...
break
    ...
    if ((isMedia && !mek.message.videoMessage || isQuotedImage || isQuotedVideo ) && args.length == 0) {
            ...
            owgi = await Saduwa.downloadMediaMessage(boij)
...
//══════════[ LEVELING FEATURES ]══════════//
	...
	case 'level':
					...
					Saduwa.sendMessage(from, resul, text, { quoted: mek})
					.catch(async (err) => {
					console.error(err)
					await reply(`Error!\n${err}`)
					})
					...
					case 'profile':
					if (!isGroup) return reply(mess.group)
				    let anuprofileoke = await Saduwa.groupMetadata(from)
                    const thu = await Saduwa.getStatus(anuprofileoke.participants[0], MessageType.text)
    				Saduwa.updatePresence(from, Presence.composing)
    				try {
					ppimg = await Saduwa.getProfilePicture(`${sender.split('@')[0]}@s.whatsapp.net`)
					} catch {
					ppimg = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
					}
					profile = `╭─「 *💖ʏᴏᴜʀ ᴘʀᴏꜰɪʟᴇ💖* 」\n│• 𝗡𝗮𝗺𝗲 : ${pushname}\n│• 𝗡𝘂𝗺𝗯𝗲𝗿 : ${sender.split("@")[0]}\n│• 𝗕𝗶𝗼 : ${bio_user}\n│• 𝗫𝗣 : ${getLevelingXp(sender)}\n│• 𝗟𝗲𝘃𝗲𝗹 : ${getLevelingLevel(sender)}\n│• 𝗥𝗮𝗻𝗸 : ${role}\n│• 𝗣𝗠 : wa.me/${sender.split("@")[0]}\n╰──────────────────`
					buffer = await getBuffer(ppimg)
					Saduwa.sendMessage(from, buffer, image, {quoted: mek, caption: profile})
					break
...
case 'ttp4':  
				...
				case 'attp':
					...
					Saduwa.sendMessage(from, atetepe12, sticker, { quoted: mek })
					break
case 'memegenerator': case 'memegen':{
									...
									try {
									   ...
									   var mediiia = await Saduwa.downloadMediaMessage(enmediaokekek)
										...
										Saduwa.sendMessage(from, resu, image, {caption:'.stikerin bang', thumbnail: Buffer.alloc(0), quoted: mek})
 	...
 	case 'stickermeme': case 'memesticker': case 'memestick': case 'stickmeme': case 'stcmeme': case 'smeme':{
						if (args.length < 1) return reply(`Send orders *${prefix + command}* DogeBot`)
									...
									try {
										...
										var mediia = await Saduwa.downloadMediaMessage(enmedialel)
...
case 'takesticker':
					case 'take':
						...
						const media2 = await Saduwa.downloadAndSaveMediaMessage(encmediaoo1, `./sticker/${sender}`)
						const packname = ppp.split('|')[0]
						const author = ppp.split('|')[1]
						exif.create(packname, author, `takestick_${sender}`)
						exec(`webpmux -set exif ./sticker/takestick_${sender}.exif ./sticker/${sender}.webp -o ./sticker/${sender}.webp`, async (error) => {
							if (error) return reply(mess.error.api)
							Saduwa.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), sticker, {quoted: mek})
...
case 'stickerwm':
					case 'swm':
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							...
							const media = await Saduwa.downloadAndSaveMediaMessage(encmedia9191, `./sticker/${sender}`)
							...
							const media = await Saduwa.downloadAndSaveMediaMessage(encmediaokekak, `./sticker/${sender}`)
							...
							sticWait(from)
								await ffmpeg(`${media}`)
									...
									.on('end', function () {
										...
										exec(`webpmux -set exif ./sticker/stickwm_${sender}.exif ./sticker/${sender}.webp -o ./sticker/${sender}.webp`, async (error) => {
											if (error) return reply(mess.error.api)
											Saduwa.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), sticker, {quoted: ftex})
											fs.unlinkSync(media)
											fs.unlinkSync(`./sticker/${sender}.webp`)
											fs.unlinkSync(`./sticker/stickwm_${sender}.exif`)
										})
...
const media = await Saduwa.downloadAndSaveMediaMessage(encmedialoli)
ran = '666.webp'
await ffmpeg(`./${media}`)
.input(media)
.on('start', function (cmd) {
...
.on('end', function () {
console.log('Finish')
Saduwa.sendMessage(from, fs.readFileSync(ran), sticker, {quoted: mek})
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
.addOutputOptions([`-vcodec`, `libwebp`, `-vf`, `scale='min(320,iw)':min'(320,ih)':force_original_aspect_ratio=decrease,fps=15, pad=320:320:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`])
...
const media = await Saduwa.downloadAndSaveMediaMessage(encmedialoli22)
ran = '999.webp'
reply(mess.wait)
await ffmpeg(`./${media}`)
...
var media = await Saduwa.downloadAndSaveMediaMessage(enmediahe1)
var njay = await imgbb('520bd6f6209077d1777c2a4f20c509c2', media)
var resu = await getBuffer(`https://api.memegen.link/images/custom/${teks1}/${teks2}.png?background=${njay.display_url}`)
Saduwa.sendMessage(from, resu, image, {quoted: mek})
fs.unlinkSync(media)
} catch (e) {
return reply(`${e}`)
console.log(e)
      ...
      if (!isGroup) return reply(mess.only.group)
        ...
        break
                  ...
                  sange = body.slice(1)
					...
					Saduwa.sendMessage(from, 'Question : *'+sange+'*\n\nAnswer: '+ nge+'%', text, { quoted: mek })
					break
                case 'gaycheck':
					// source code by xeon⛔
                  gayy = body.slice(1)
					...
					Saduwa.sendMessage(from, 'Question : *'+gayy+'*\n\nAnswer : '+ yag+'%', text, { quoted: mek })
					break
                case 'lesbicheck':
                case 'lesbiancheck':
					// source code by xeon⛔
                  lesbii = body.slice(1)
					...
					Saduwa.sendMessage(from, 'Question : *'+lesbii+'*\n\nAnswer : '+ bi+'%', text, { quoted: mek })
					break
                case 'handsomecheck':
					// source code by xeon⛔
ganteng = body.slice(1)
					...
					Saduwa.sendMessage(from, 'Question : *'+ganteng+'*\n\nAnswer : '+ teng+'%', text, { quoted: mek })
					break
		case 'beautycheck':
					// source code by xeon⛔
cantik = body.slice(1)
					...
					Saduwa.sendMessage(from, 'Question : *'+cantik+'*\n\nAnswer : '+ tik+'%', text, { quoted: mek })
					break
		case 'charactercheck':
					// source code by xeon⛔
watak = body.slice(1)
					...
					Saduwa.sendMessage(from, 'Question : *'+watak+'*\n\nAnswer : '+ tak, text, { quoted: mek })
				        break
...
//══════════[ GAME FEATURES ]══════════//
    ...
    "breakup with your best friend for 5hrs without telling him/her that its a dare",
     ...
     "send abusive words in any grup, excepting this grup, and send screenshot proof here"
              ...
              Saduwa.sendMessage(from, buffer, image, { quoted: mek, caption: '_*DARE*_\n'+ der })
              break
                            break
       case 'truth':
              const truth =[
    ...
    "do you play pubg, if you then send ur id number"
              ...
              buffer = await getBuffer(`https://i.ibb.co/305yt26/bf84f20635dedd5dde31e7e5b6983ae9.jpg`)
              Saduwa.sendMessage(from, buffer, image, { quoted: mek, caption: '_*TRUTH*_\n'+ trut })
              break
...
case 'bc':
             ...
             if (args.length < 1) return reply('Where is the text?')
             anu100 = await Saduwa.chats.all()
             if (isMedia && !Saduwa.message.videoMessage || isQuotedImage) {
             const encmediaboomb = isQuotedImage ? JSON.parse(JSON.stringify(Saduwa).replace('quotedM','m')).message.extendedTextMessage.contextInfo : Saduwa
             bc100 = await Saduwa.downloadMediaMessage(encmediaboomb)
             for (let _ of anu100) {
             Saduwa.sendMessage(_.jid, bc100, image, {quoted: fgi, caption: `*「 Doge Bot Broadcast 」*\n\n${body.slice(4)}`})
}
             reply('Broadcast success')
             } else {
             for (let _ of anu100) {
             Saduwa.sendMessage(_.jid, 
			{"contentText": `*「 SADUWA-BOT BROADCASTING MESSAGE 」*\n\n${body.slice(4)}`,
			"footerText": `${tanggal}`,
			"buttons": [
...
buff = await Saduwa.downloadMediaMessage(encmedia12345)
for (let _ of anubc2) {
Saduwa.sendMessage(_.jid, buff, image, { viewOnce:true, caption: `${body.slice(4)}`})
}
...
buff = await Saduwa.downloadMediaMessage(encmediaki)
for (let _ of anubc2) {
Saduwa.sendMessage(_.jid, buff, video, { viewOnce:true, caption: `${body.slice(4)}`})
}
reply(`Broadcast success ${body.slice(4)}`)
} else if (isMedia && !mek.message.videoMessage || isQuotedVideo) {
...
buff = await Saduwa.downloadMediaMessage(encmediadirk)
for (let _ of anubc2) {
Saduwa.sendMessage(_.jid, buff, video, { mimetype: Mimetype.gif, quoted: finv, contextInfo: { forwardingScore: 508, isForwarded: true}, caption: `${body.slice(4)}` })
}
reply(`Broadcast success ${body.slice(4)}`)
} else {
for (let _ of anubc2) {
...
bcgc = await Saduwa.downloadMediaMessage(encmediabcgc)
for (let _ of groupMembers) {
Saduwa.sendMessage(_.jid, bcgc, image, { caption: `*「 SADUWA-BOT BROADCAST 」*\n*Group* : ${groupName}\n\n${body.slice(6)}` })
}
reply('')
} else {
for (let _ of groupMembers) {
sendMess(_.jid, `*「 SADUWA-BOT BROADCAST 」*\n*Group* : ${groupName}\n\n${body.slice(6)}`)
}
...
if (!isOwner && !mek.key.fromMe) return  reply(mess.only.owner)
anuclearall = await Saduwa.chats.all()
Saduwa.setMaxListeners(25)
for (let _ of anuclearall) {
Saduwa.deleteChat(_.jid)
}
...
media = await Saduwa.downloadAndSaveMediaMessage(enmediaheheh, './database/sampah/media_user')
await Saduwa.updateProfilePicture(botNumber, media)
...
Saduwa.updateProfileName(anuoke112)
...
if (!Number(oi2)) return reply('The number must be a number!')
	  for (let i = 0; i < oi2; i++) {
	  Saduwa.sendMessage(from, `${oi1}`, MessageType.text)
	  }
...
if (Number(args[0]) >= 50) return reply('Max 50!')
	  ...
	  Saduwa.sendMessage(from, teks, MessageType.text)
	  }
	...
	if (Number(args[0]) >= 50) return reply('Max 50!')
	  for (let i = 0; i < args[0]; i++) {
	  Saduwa.sendMessage(from, anutospem, sticker)
	  }
} else if (isQuotedAudio) {
	encmediat = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
	            mediat = await Saduwa.downloadAndSaveMediaMessage(encmediat)
				anutospem2 = fs.readFileSync(mediat)
	if (!Number(args[0])) return reply('Amount must be a number!')
	if (Number(args[0]) >= 50) return reply('Max 50!')
	  for (let i = 0; i < args[0]; i++) {
	  Saduwa.sendMessage(from, anu2spem2, audio, {mimetype: 'audio/mp4', duration: 359996400, ptt:true})
	  }
} else if (isQuotedImage) {
	boij = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek
	delb = await Saduwa.downloadMediaMessage(boij)
	teks = body.slice(6)
	oi1 = teks.split('|')[0]
oi2 = teks.split('|')[1]
if (Number(oi2) >= 50) return reply('Max 50!')
	if (!Number(oi2)) return reply('Amount must be a number!')
	  for (let i = 0; i < oi2; i++) {
	  Saduwa.sendMessage(from, delb, MessageType.image, {caption: oi1})
	  }
}
	  break
	case 'spam':
				...
				for (let i = 0; i < argzi[1]; i++){
					Saduwa.sendMessage(from, argzi[0], MessageType.text)
				}
				break
				      case 'leaveall':
             if (!isOwner) return  reply(mess.only.owner)
             let totalgroup = Saduwa.chats.array.filter(u => u.jid.endsWith('@g.us')).map(u => u.jid)
             for (let id of totalgroup) {
             sendMess(id, 'byee!', null)
             Saduwa.groupLeave(id)
}
             break
             case 'addvn':
					if (!isOwner && !mek.key.fromMe) return reply(mess.owner)
					...
					Saduwa.sendMessage(from, `Success, please check with *${prefix}vnlist*`, MessageType.text, { quoted: mek })
					break
					case 'delvn':
					if (!isOwner && !mek.key.fromMe) return reply(mess.owner)
					try {
				...
				case 'listvn':
					...
					Saduwa.sendMessage(from, teks.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": vien } })
					break
					case 'addimage':
				if (!isOwner && !mek.key.fromMe) return reply(mess.owner)
					...
					Saduwa.sendMessage(from, `Success, please check with *${prefix}imglist*`, MessageType.text, { quoted: mek })
					break
				case 'delimage':
				if (!isOwner && !mek.key.fromMe) return reply(mess.owner)
					try {
				...
				case 'listimage':
					...
					Saduwa.sendMessage(from, teks.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": imagi } })
					break
					case 'addsticker':
				if (!isOwner && !mek.key.fromMe) return reply(mess.owner)
					if (!isQuotedSticker) return reply('Reply sticker')
					...
					Saduwa.sendMessage(from, `Success, please check with *${prefix}liststicker*`, MessageType.text, { quoted: mek })
					break
				case 'delsticker':
				if (!isOwner && !mek.key.fromMe) return reply(mess.owner)
					try {
				...
				case 'liststicker':
					...
					Saduwa.sendMessage(from, teks.trim(), extendedText, { quoted: mek, contextInfo: { "mentionedJid": setik } })
					break
					break
...
//══════════[ GROUP FEATURES ]══════════//
			...
			if (!isGroup) return reply(mess.only.group)
				...
				if (mek.message.extendedTextMessage != undefined){
					...
					Saduwa.groupCreate(argz[0], anucgc)
					reply(`Success in creating a group ${argz[0]}`)
                }
				break
case 'getbio':
	  var yy = mek.message.extendedTextMessage.contextInfo.participant
var p = await Saduwa.getStatus(`${yy}`, MessageType.text)
reply(p.status)
if (p.status == 401) {
reply(mess.error.api)
}
...
case 'getdp':
            ...
            pictt = await Saduwa.getProfilePicture(mentioned)
            pict = await getBuffer(pictt)
            Saduwa.sendMessage(from, pict, image, {quoted: mek})
            break
                    case 'getname':
        var ambl = mek.message.extendedTextMessage.contextInfo.participant
const sname = Saduwa.contacts[ambl] != undefined ? Saduwa.contacts[ambl].notify = undefined ? PhoneNumber('+' + ambl.replace('@s.whatsapp.net', '')).getNumber('international') : Saduwa.contacts[ambl].notify || Saduwa.contacts[ambl].vname : PhoneNumber('+' + ambl.replace('@s.whatsapp.net', '')).getNumber('international')
reply(sname)
break
case 'leave':
            if (!isGroup) return reply(mess.only.group)
                    if (isGroupAdmins || isOwner) {
                    	Saduwa.groupLeave(from)
                    } else {
...
case 'getdescgc':
				...
				if (!isGroup) return reply(mess.only.group)
					anugetdescgc = from
			   metadete = await Saduwa.groupMetadata(anugetdescgc)
				Saduwa.sendMessage(from, metadete.desc, text, {quoted:mek})
				  break
case 'nsfw':
...
await Saduwa.sendMessage(from, bMess, MessageType.buttonsMessage, {quoted: mek})
break
					case 'opengc':
					if (!isGroup) return reply(mess.only.group)
                   ...
                   reply(`Successful opening group ${groupName}`)
						Saduwa.groupSettingChange(from, GroupSettingChange.messageSend, false)
						break
						case 'closegc':
						if (!isGroup) return reply(mess.only.group)
                   ...
                   if (!isBotGroupAdmins) return sticNotAdmin(from)
						...
						Saduwa.groupSettingChange(from, GroupSettingChange.messageSend, true)
					break
case 'grouplink':
case 'gruplink':
case 'gclink':
...
if (!isGroup) return reply(mess.only.group)
if (!isBotGroupAdmins) return reply(mess.only.Badmin)
linkgc = await Saduwa.groupInviteCode(from)
yeh = `https://chat.whatsapp.com/${linkgc}\n\n*${groupName}* group link`
Saduwa.sendMessage(from, yeh, text, { quoted: fgi })
break
case 'promote' :
...
Saduwa.groupMakeAdmin(from, mentioned)
} else {
...
mentions(teks, mentioned, true)
Saduwa.groupDemoteAdmin(from, mentioned)
} else {
...
Saduwa.groupDemoteAdmin(from, members_id)
break
case 'promoteall':
...
Saduwa.groupMakeAdmin(from, members_id)
break
case 'add' :
...
if (!isGroupAdmins) return reply(mess.only.admin)
if (!isBotGroupAdmins) return reply(mess.only.Badmin)
Saduwa.groupUpdateSubject(from, `${body.slice(9)}`)
Saduwa.sendMessage(from, `\`\`\`Success ✅, Renamed the group to\`\`\` *${body.slice(9)}*`, text, { quoted: mek })
break
case 'setdesc':
...
if (!isGroupAdmins) return reply(mess.only.admin)
if (!isBotGroupAdmins) return reply(mess.only.Badmin)
Saduwa.groupUpdateDescription(from, `${body.slice(9)}`)
Saduwa.sendMessage(from, `\`\`\`Success ✅, Changing group description\`\`\` *${groupMetadata.subject}* Became: *${body.slice(9)}*`, text, { quoted: fgi })
break
case 'setgrouppp':
case 'setgruppp':
case 'setpp':
...
let media = await Saduwa.downloadMediaMessage(encmediasetppgc)
Saduwa.updateProfilePicture(from, media)
...
if (!isGroup) return reply(mess.only.group)
try {
var pic = await Saduwa.getProfilePicture(from)
} catch {
var pic = 'https://i.ibb.co/Tq7d7TZ/age-hananta-495-photo.png'
}
let ingfo = `*G R O U P I N F O*\n\n*Name :* ${groupName}\n*Group ID :* ${from}\n*Made :* ${moment(`${groupMetadata.creation}` * 1000).tz('Asia/Kolkata').format('DD/MM/YYYY HH:mm:ss')}\n*Group Owner :* @${groupMetadata.owner.split('@')[0]}\n*Number of Admins :* ${groupAdmins.length}\n*Number of participants :* ${groupMembers.length}\n*Welcome :* ${isWelkom ? 'Aktif' : 'Mati'}\n*AntiLink :* ${isAntiLink ? 'Aktif' : 'Mati'}\n*Desc :* \n\n${groupMetadata.desc}`
Saduwa.sendMessage(from, await getBuffer(pic), image, {quoted: mek, caption: ingfo, contextInfo: {"mentionedJid": [groupMetadata.owner.replace('@c.us', '@s.whatsapp.net')]}})
break
case 'resetlinkgc':
case 'resetlinkgroup':
case 'resetlinkgrup':
...
Saduwa.query({json, expect200: true})
...
break
       ...
       case 'here':                
             ...
             let online = [...Object.keys(Saduwa.chats.get(ido).presences), Saduwa.user.jid]
             Saduwa.sendMessage(from, 'List Online:\n' + online.map(v => '- @' + v.replace(/@.+/, '')).join `\n`, text, { quoted: mek, contextInfo: { mentionedJid: online }})
             } catch (e) {
             reply(`${e}`)
}
             break
...
case 'sticktag':
            ...
            file = await Saduwa.downloadAndSaveMediaMessage(encmediau, filename = getRandom())
            value = args.join(" ")
            var group = await Saduwa.groupMetadata(from)
            ...
            Saduwa.sendMessage(from, ini_buffer, sticker, options)
            fs.unlinkSync(file)
            ...
            ini_buffer = fs.readFileSync(file)
            Saduwa.sendMessage(from, ini_buffer, image, options)
            fs.unlinkSync(file)
            ...
            ini_buffer = fs.readFileSync(file)
            Saduwa.sendMessage(from, ini_buffer, audio, options)
            fs.unlinkSync(file)
            ...
            ini_buffer = fs.readFileSync(file)
            Saduwa.sendMessage(from, ini_buffer, video, options)
            fs.unlinkSync(file)
            ...
            ini_buffer = fs.readFileSync(file)
            Saduwa.sendMessage(from, ini_buffer, document, options)
            fs.unlinkSync(file)
        }  else if ((isMedia && !mek.message.videoMessage || isQuotedVideo) && args.length == 0) {
            encmediau = isQuotedVideo ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
            file = await Saduwa.downloadAndSaveMediaMessage(encmediau, filename = getRandom())
...
Saduwa.sendMessage(from, options, text, { quoted: mek })
break
case 'contag':
...
reply(`${err}`)
	...
	Saduwa.sendMessage(`${owner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Dark Saduwaツ",body:"Dont forget to subscribe Xeon",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/menu1.jpg'),sourceUrl:"https://wa.me/94761905764"}}})
        }
	// console.log(e)
	}
}
